    ...
    makeVerifiedRequest({
      url: `/${
        title === 'Jobseekers Documents'
          ? 'jobseekers/user-document-review/approved'
          : 'employer/user-profile-review/approved'
      }/verified/`,
    });
    makeDeclinedRequest({
      url: `/${
        title === 'Jobseekers Documents'
          ? 'jobseekers/user-document-review/declined'
          : 'employer/user-profile-review/declined'
      }/declined/`,
    });
    makePendingRequest({
      url: `/${
        title === 'Jobseekers Documents'
          ? 'jobseekers/user-document-review/pending'
          : 'employer/user-profile-review/pending'
      }/pending/`,
    });
  }, []);
